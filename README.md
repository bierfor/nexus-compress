...
| data.json | 635 KB | 168 KB | **3.77x** | 50 KB (12.7x) | 3.4x worse |
...
| text.txt | 178 KB | 91 KB | **1.96x** | 32 KB (5.6x) | 2.8x worse |
| **aggregate** | 1.56 MB | 588 KB | **2.67x** | 365 KB (4.30x) | — |
...
- Sprint 2.3 (RLE pre-filter) gives a small +1.4% win on code.rs; net
  neutral on other files. See "RLE pre-filter (sprint 2.3)" below.
