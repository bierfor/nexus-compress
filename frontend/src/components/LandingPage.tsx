  ...
  return (
    ...
    >
      <div className="flex-1 min-w-0">
        <p className="text-zinc-200 text-[13px] truncate font-medium">
          {op.filename}
        </p>
        <p className="text-zinc-600 text-[11px] mt-0.5 font-mono tabular-nums">
          {prettyBytes(inputSize)} → {prettyBytes(outputSize)} · {verb}
        </p>
      </div>
      {saved !== null && saved > 0 && (
