...
repository, the issue tracker, pull requests, discussions, and any
other channel where the community interacts — and also applies when
an individual is officially representing the community in public
spaces. Examples of representing our community include using an
official e-mail address, posting via an official social media
...
at **conduct@nexuscompress.dev**. All complaints will be reviewed and
